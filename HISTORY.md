...
- Minor change. [Souradip Pal]
- Fixed device map issue. [Souradip Pal]
- Minor fixes. [Souradip Pal]
- Merge pull request #14 from
  souradipp76/dependabot/github_actions/codecov/codecov-action-5.
  [Souradip Pal]
...
- Bump codecov/codecov-action from 4 to 5. [dependabot[bot]]
  ...
  ...
- Adjusted prompts. [Souradip Pal]
- Fixed tests and updated CONTRIBUTING.md. [Souradip Pal]
- Fixing utils. [Souradip Pal]
- Minor fix. [Souradip Pal]
- Updated example. [Souradip Pal]
- Updated README and added example. [Souradip Pal]
- Modified paper.md. [Souradip Pal]
- Removed tokens. [Souradip Pal]
- Update VERSION. [Sayak Chakrabarty]
- Update main.yml. [Sayak Chakrabarty]
- Rename project. [Souradip Pal]
- Update setup.py. [Sayak Chakrabarty]
- Update README.md. [Sayak Chakrabarty]
- Update VERSION. [Sayak Chakrabarty]
- Update main.yml. [Sayak Chakrabarty]
- Updated README. [Souradip Pal]
- Fixed tests and bib. [Souradip Pal]
- Tests. [hellokayas]
- Tests. [hellokayas]
- Tests. [hellokayas]
- Partially fixed tests. [Souradip Pal]
- Tests. [hellokayas]
- Merge branch 'main' of https://github.com/souradipp76/doc_generator.
  [hellokayas]
- Corrected qa mode and test. [Souradip Pal]
- Fixed scripts and README. [Souradip Pal]
- Added missing tests and fixed formatting. [Souradip Pal]
- Tests. [hellokayas]
- Fixed tests and workflow. [Souradip Pal]
...
- Data Cleaning code. [Sayak Chakrabarty]
- Updated version in workflows. [souradipp76]
- Corrected version in workflows. [souradipp76]
- Minor changes. [souradipp76]
- Minor change. [souradipp76]
- Some changes. [souradipp76]
- Removed tests_mac from workflows. [souradipp76]
- Updated requirements. [souradipp76]
- Resolve linting errors. [souradipp76]
- Fixed linting errors. [souradipp76]
- Fixed some linting errors. [souradipp76]
- Fixed some linting errors. [souradipp76]
- Linting code. [souradipp76]
- Removed unused file. [souradipp76]
- Fixes for running other models options. [souradipp76]
- Corrected models options. [souradipp76]
- Some changes in user inputs and model options. [souradip_pal]
- Setting up mkdocs for testing. [souradip_pal]
- Added multiple models options. [souradipp76]
- Fixed output for README generation. [souradipp76]
- Changes in script. [souradip_pal]
- Changed path in script. [souradip_pal]
- Added script for dataset creation. [souradip_pal]
- Notebook. [Sayak Chakrabarty]
- Updated data.ipynb. [souradip_pal]
- Some changes to generate readme. [souradip_pal]
- Scripts folder. [Sayak Chakrabarty]
...
- Bump actions/checkout from 3 to 4. [dependabot[bot]]
  ...
  - dependency-name: actions/checkout
    ...
    update-type: version-update:semver-major
  ...
- Fixed questions for README generation. [souradipp76]
- Changed prompt for readme. [souradip_pal]
- Repos. [Sayak Chakrabarty]
- Context dataset sample. [souradipp76]
- Updates. [Sayak Chakrabarty]
- Ipynb. [Sayak Chakrabarty]
- Data.py. [Sayak Chakrabarty]
- Some minor adjustments. [souradipp76]
- Changed chunk size to fit in max length. [souradip_pal]
- Fixes in HNSWLib. [souradip_pal]
- Some changes in chain. [souradip_pal]
- Some changes for query. [souradipp76]
- Some changes in HNSWLib. [souradip_pal]
- Fixes for vector store. [souradipp76]
- Some changes in vectore store indexing. [souradip_pal]
- Fixes for LLama2. [souradipp76]
- Some fixes in llama2. [souradip_pal]
- Using llama2 chat model. [souradip_pal]
- Fixed indexing issues. [souradip_pal]
