...
fmt:              ## Format code using black & isort.
	$(ENV_PREFIX)isort readme_ready/
	$(ENV_PREFIX)black -l 79 readme_ready/
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "readme_ready = 'readme_ready.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run readme_ready'"
